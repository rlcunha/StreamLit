...
def create_movimentos(id_caixa, tipo_movimento, valor, data_hora, descricao):
...
menu = st.sidebar.selectbox("Selecione a Entidade", ["Caixa", "Operadora_Credito", "Op_Credito"])
    ...
    if crud_operation == "Create":
        ...
        if st.button("Create Caixa"):
            create_caixa(
                caixa_aberto,
                data, 
                parse_currency(saldo_inicial), 
                parse_currency(valor_cartao_credito), 
                parse_currency(valor_cartao_debito), 
                parse_currency(valor_ifood), 
                parse_currency(valor_dinheiro), 
                parse_currency(valor_fiado), 
                parse_currency(saidas_caixa), 
                parse_currency(valor_acrescimo)
            )
